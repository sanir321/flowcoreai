...
import { Plus, CheckCircle2, MessageSquare, LayoutGrid, X, Target, Zap, Bot, Loader2 } from "lucide-react"
                 ...
                 <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-8">
                    {isLoading ? (
                      Array.from({ length: 3 }).map((_, i) => (
                        <div key={i} className="h-[420px] w-full max-w-[340px] rounded-[2.5rem] border border-gray-100 bg-gray-50/50 animate-pulse" />
                      ))
                    ) : (
                      <>
                        {agents.map((agent, i) => (

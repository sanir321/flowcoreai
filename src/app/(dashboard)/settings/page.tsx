           ...
           <div className="space-y-6">
              ...
              <div className="space-y-2.5">
                 ...
                 <Select 
                    ...
                    onValueChange={(val) => setWorkspace(prev => prev ? { ...prev, business_type: val } : null)}
                 >
              ...
              <div className="space-y-2.5">
                 ...
                 <Input 
                   ...
                   onChange={(e) => setWorkspace(prev => prev ? { ...prev, owner_personal_phone: e.target.value } : null)}
              ...
              <div className="space-y-2.5 pt-4 border-t border-gray-50">
                 ...
                 <Select 
                    ...
                    onValueChange={(val) => setWorkspace(prev => prev ? { ...prev, timezone: val } : null)}
                 >
                    <SelectTrigger className="h-12 border-gray-200 focus:ring-0 bg-gray-50/30 text-gray-900">
                    <SelectValue />
                    </SelectTrigger>

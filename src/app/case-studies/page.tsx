...
export const metadata: Metadata = {
  title: "Case Studies — Real Businesses Using Flowcore AI",
  description: "See how businesses use Flowcore AI to automate customer service, reduce response times, and scale support operations across WhatsApp and webchat.",
  keywords: [
    "Flowcore AI case studies",
    "WhatsApp automation examples",
    "AI customer service success stories",
    "business automation case studies",
  ],
  openGraph: {
    title: "Case Studies — Flowcore AI Customer Success Stories",
    description: "Real businesses automating customer service with Flowcore AI.",
...
const caseStudies = [
  {
    ...
    solution: "Deployed Flowcore AI with a custom-trained knowledge base containing all property listings, pricing sheets, and FAQ documents. Configured the Booking Agent for site visit scheduling synced with Google Calendar.",
    results: [
  ...
  },
  {
    ...
    solution: "Implemented Flowcore AI with a custom agent trained on the menu, pricing, table layouts, and reservation policies. Connected WhatsApp Business API for customer inquiries and automated order management.",
    results: [
  ...
  },
  {
    ...
    solution: "Deployed Flowcore AI with Appointment Booking Agent trained on doctor schedules, insurance policies, and clinic locations. Integrated with Google Calendar for real-time slot availability and automated reminders.",
    results: [
      ...
      <main style={{ maxWidth: "900px", margin: "0 auto", padding: "80px 24px 120px" }}>
        <header style={{ marginBottom: "72px", textAlign: "center" }}>
          ...
          <p style={{ fontSize: "15.667px", color: "#595859", marginTop: "12px", maxWidth: "600px", margin: "12px auto 0" }}>
            Real businesses using Flowcore AI to automate customer service, reduce response times, and scale support.
          </p>
        </header>
        ...
        {caseStudies.map((cs, i) => (
          <article key={cs.company} style={{ marginBottom: "80px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "8px" }}>
              <span style={{ fontSize: "13px", color: "#c65f39", background: "rgba(198,95,57,0.1)", padding: "2px 10px", borderRadius: "4px" }}>
                {cs.industry}
              </span>
            ...
            <p style={{ fontSize: "18px", color: "#c65f39", margin: "0 0 24px", lineHeight: 1.4 }}>
              {cs.headline}
            </p>
                ...
                <ul style={{ margin: 0, padding: 0, listStyle: "none" }}>
                  {cs.results.map((result) => (
                    <li key={result} style={{ fontSize: "15.667px", lineHeight: 1.8, color: "#c0c0c0", paddingLeft: "20px", position: "relative" }}>
                      <span style={{ position: "absolute", left: 0, color: "#c65f39" }}>&#10003;</span>
                      {result}
                    </li>
                  ))}
                </ul>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "ItemList",
            "name": "Flowcore AI Case Studies",
            "description": "Real businesses using Flowcore AI to automate customer service.",

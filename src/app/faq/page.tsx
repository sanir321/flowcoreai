...
export const metadata: Metadata = {
  ...
  description: "Answers to common questions about Flowcore's AI customer service platform, WhatsApp integration, pricing, and features.",
  keywords: [
    "Flowcore FAQ",
  ...
  openGraph: {
    title: "Frequently Asked Questions | Flowcore",
    description: "Answers to common questions about Flowcore's AI customer service platform.",
    url: `${siteUrl}/faq`,
    images: [
      {

...
export const metadata: Metadata = {
  ...
  description: "Flowcore's Acceptable Use Policy (AUP) defining prohibited activities and proper use of our AI platform.",
  keywords: ["Flowcore AUP", "acceptable use policy", "platform rules", "prohibited activities"],
  openGraph: {
    title: "Acceptable Use Policy — Flowcore",
    description: "Rules and prohibited activities for Flowcore platform usage.",
...
This Acceptable Use Policy ("AUP") governs your use of Flowcore ("Service"). By using the Service, you agree to comply with this policy. Violations may result in account suspension or termination.

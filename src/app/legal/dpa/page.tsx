...
export const metadata: Metadata = {
  ...
  description: "Flowcore's Data Processing Agreement (DPA) governing how we process customer data as a processor under DPDP Act 2023.",
  keywords: ["Flowcore DPA", "data processing agreement", "DPDP Act", "data processor"],
  openGraph: {
    title: "Data Processing Agreement — Flowcore",
    description: "How Flowcore processes customer data under DPDP Act 2023.",
...
- **Flowcore** ("Processor"), operating from Chennai, Tamil Nadu, India
- The customer subscribing to Flowcore's services ("Controller")

---

## 2. Scope

This DPA governs the Processor's processing of Personal Data on behalf of the Controller when using the Flowcore platform. It applies to all Personal Data processed through the Service, including end-customer data routed through WhatsApp, webchat, and email channels.

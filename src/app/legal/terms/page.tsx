...
export const metadata: Metadata = {
  ...
  description: "Flowcore's terms and conditions governing the use of our AI customer service platform and services.",
  keywords: ["Flowcore terms", "terms of service", "platform terms", "SaaS terms"],
  openGraph: {
    title: "Terms & Conditions — Flowcore",
    description: "Terms and conditions for using Flowcore's customer service platform.",
...
By registering for or using Flowcore ("Service", "Platform"), you ("User", "Subscriber", "you") agree to be bound by these Terms and Conditions ("Terms"). If you are registering on behalf of a business, you represent that you have authority to bind that business.
...
Flowcore provides a multi-tenant SaaS platform that enables businesses to:
...
### 4.1 Plans
Flowcore offers tiered subscription plans (Starter, Growth, Scale) billed monthly or annually.
...
Your use of Flowcore's WhatsApp integration is subject to:
...
You are solely responsible for obtaining customer consent before messaging them via WhatsApp and for complying with all applicable WhatsApp Business policies. Flowcore is not liable for account bans imposed by Meta due to your violation of their policies.
...
- Flowcore makes no warranty that AI responses will be error-free or fit for any specific business purpose.
...
### 7.1 Our IP
All software, designs, trademarks, and content comprising the Flowcore platform are our exclusive property or licensed to us. You may not copy, reproduce, or redistribute any part of the platform.
...
- Flowcore's total liability for any claim arising out of or related to these Terms shall not exceed the **amount you paid us in the 3 months preceding the claim**.

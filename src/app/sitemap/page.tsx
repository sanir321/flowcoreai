...
export const metadata: Metadata = {
  title: "Sitemap",
  description: "Complete sitemap of Flowcore — find all pages including features, pricing, FAQ, changelog, about, and legal pages.",
  robots: { index: true, follow: true },
  openGraph: {
    title: "Sitemap - Flowcore",
    description: "Complete sitemap of Flowcore.",
    url: `${siteUrl}/sitemap`,
    images: [
      {
    ...
    <>
      ...
      <main style={{
        ...
        <p style={{
          ...
          All pages on Flowcore organized for easy navigation.
        </p>
        <ul style={{

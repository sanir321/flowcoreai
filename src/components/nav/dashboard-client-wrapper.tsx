...
export function DashboardClientWrapper({
  ...
  const isFullBleed = useMemo(() => {
    const fullBleedRoutes = ['/inbox', '/insights', '/agent-hub', '/ceo', '/agent-hub/test', '/agent-hub/tools', '/agent-hub/escalations']
    ...
    <div className="flex h-dvh bg-white font-sans text-gray-900 selection:bg-[#c65f39]/10 selection:text-[#c65f39]">
      ...
      <main className={cn(
        ...
        <div className={cn(
          ...
          !isFullBleed ? "p-3 md:p-4 lg:p-6 overflow-hidden" : "text-gray-900 overflow-hidden"
        )}>
          <PageTransition>
            {children}
          </PageTransition>

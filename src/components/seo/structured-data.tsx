  ...
  const schemas = [
    {
      ...
      "foundingDate": "2025",
      "contactPoint": { "@type": "ContactPoint", "email": "support@Flowter.ai", "contactType": "customer service", "availableLanguage": "English" },
    ...
    },
    {
      ...
      "@id": `${siteUrl}#webpage`,
      "url": siteUrl,
      "name": "Flowter — Automated Customer Service & AI Assistants",
      "description": "AI-powered customer service orchestration platform for WhatsApp and webchat.",
      "publisher": { "@type": "Organization", "@id": `${siteUrl}#organization` },
    ...
    },
    {
      ...
      "description": "AI-powered customer service orchestration platform for WhatsApp and webchat.",
      "url": siteUrl,
      "screenshot": `${siteUrl}/api/og?title=Flowter%20AI&subtitle=AI%20Customer%20Service%20Platform`,
      "featureList": [

...
function postgrestEscape(value: any): string {
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (e.message !== "Failed to parse webhook body") {
      // ignore
    }
...
async function processMessage(payload: WebhookPayload): Promise<[TierResult, PipelineContext] | Response> {
